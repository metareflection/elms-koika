...
struct StateT * v2001(struct StateT * v2002) {
  ...
  struct StateT * v10982;
  if (v11818) {
    int v3255 = v2002->timer;
    int v11819 = v3255 + 15;
    v2002->timer = v11819;
    int * v3257 = v2002->saved_regs;
    int v3258 = v3257[15];

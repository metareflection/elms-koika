...
struct StateT * v19(struct StateT * v20) {
  ...
  int v25 = v20->timer;
  int v1196 = v25 + 1;
  v20->timer = v1196;int * v27 = v20->regs;
  v27[12] = 0;
...
struct StateT * v15(struct StateT * v16) {
  int v17 = v16->timer;
  int v1203 = v17 + 1;
  v16->timer = v1203;struct StateT * v1201 = v19(v16);
  return v1201;
}
...
struct StateT * v457(struct StateT * v458) {
  ...
  int v462 = v461[15];
  bool v786 = !(v460 == v462);
  struct StateT * v780 = (v786 ? ({
    int v463 = v458->timer;
    int v787 = v463 + 15;
    v458->timer = v787;int * v465 = v458->saved_regs;
    int v466 = v465[11];
    int * v467 = v458->regs;
    v467[11] = v466;
...
struct StateT * v117(struct StateT * v118) {
  ...
  int v123 = v118->timer;
  int v1065 = v123 + 1;
  v118->timer = v1065;int * v125 = v118->regs;
  int v126 = v125[13];
...
struct StateT * v37(struct StateT * v38) {
  ...
  int v43 = v38->timer;
  int v1176 = v43 + 1;
  v38->timer = v1176;int * v45 = v38->regs;
  v45[13] = 0;
...
struct StateT * v417(struct StateT * v418) {
  int v419 = v418->timer;
  int v843 = v419 + 1;
  v418->timer = v843;struct StateT * v841 = v421(v418);
  return v841;
}
...
struct StateT * v269(struct StateT * v270) {
  int v271 = v270->timer;
  int v283 = v271 + 1;
  v270->timer = v283;int * v273 = v270->regs;
  v273[10] = 0;
...
struct StateT * v209(struct StateT * v210) {
  int v211 = v210->timer;
  int v1027 = v211 + 1;
  v210->timer = v1027;struct StateT * v1025 = v213(v210);
  return v1025;
}
...
struct StateT * v565(struct StateT * v566) {
  ...
  int v571 = v566->timer;
  int v677 = v571 + 1;
  v566->timer = v677;int * v573 = v566->regs;
  int v574 = v573[13];
...
struct StateT * v9(struct StateT * v10) {
  int v11 = v10->timer;
  int v1208 = v11 + 1;
  v10->timer = v1208;int * v13 = v10->regs;
  v13[10] = 1;
...
struct StateT * v359(struct StateT * v360) {
  int v361 = v360->timer;
  int v848 = v361 + 1;
  v360->timer = v848;int * v363 = v360->regs;
  int v364 = v363[13];
...
struct StateT * v445(struct StateT * v446) {
  ...
  int v451 = v446->timer;
  int v811 = v451 + 1;
  v446->timer = v811;int * v453 = v446->regs;
  int v454 = v453[13];
  int * v455 = v446->regs;
  int v814 = v454 + 4;
  v455[13] = v814;
...
struct StateT * v627(struct StateT * v628) {
  ...
  int v630 = v629[11];
  bool v656 = !(v630 == 0);
  struct StateT * v652 = (v656 ? ({
    struct StateT * v632 = v417(v628);
    v632;
  }) : ({
    int v634 = v628->timer;
    int v659 = v634 + 15;
    v628->timer = v659;int * v636 = v628->saved_regs;
    int v637 = v636[14];
    int * v638 = v628->regs;
    v638[14] = v637;
...
struct StateT * v29(struct StateT * v30) {
  int v31 = v30->timer;
  int v1183 = v31 + 1;
  v30->timer = v1183;int * v33 = v30->regs;
  int v34 = v33[12];
  int * v35 = v30->regs;
  int v1187 = v34 + 16;
  v35[12] = v1187;
...
struct StateT * v179(struct StateT * v180) {
  ...
  int v182 = v181[11];
  bool v1036 = 0 >= v182;
  struct StateT * v1032 = (v1036 ? ({
    int v183 = v180->timer;
    int v1037 = v183 + 15;
    v180->timer = v1037;int * v185 = v180->saved_regs;
    int v186 = v185[12];
    int * v187 = v180->regs;
    v187[12] = v186;
...
struct StateT * v477(struct StateT * v478) {
  int v479 = v478->timer;
  int v491 = v479 + 1;
  v478->timer = v491;int * v481 = v478->regs;
  v481[10] = 0;
...
struct StateT * v291(struct StateT * v292) {
  int v293 = v292->timer;
  int v959 = v293 + 1;
  v292->timer = v959;struct StateT * v957 = v295(v292);
  return v957;
}
...
struct StateT * v421(struct StateT * v422) {
  ...
  int v427 = v422->timer;
  int v835 = v427 + 1;
  v422->timer = v835;int * v429 = v422->regs;
  int v430 = v429[11];
  int * v431 = v422->regs;
  int v838 = v430 + -1;
  v431[11] = v838;
...
struct StateT * v301(struct StateT * v302) {
  int v303 = v302->timer;
  int v896 = v303 + 1;
  v302->timer = v896;int * v305 = v302->regs;
  int v306 = v305[12];
...
struct StateT * v499(struct StateT * v500) {
  int v501 = v500->timer;
  int v775 = v501 + 1;
  v500->timer = v775;struct StateT * v773 = v503(v500);
  return v773;
}
...
struct StateT * v237(struct StateT * v238) {
  ...
  int v243 = v238->timer;
  int v995 = v243 + 1;
  v238->timer = v995;int * v245 = v238->regs;
  int v246 = v245[13];
  int * v247 = v238->regs;
  int v998 = v246 + 4;
  v247[13] = v998;
...
struct StateT * v503(struct StateT * v504) {
  ...
  int v509 = v504->timer;
  int v728 = v509 + 1;
  v504->timer = v728;int * v511 = v504->regs;
  int v512 = v511[12];
...
struct StateT * v249(struct StateT * v250) {
  ...
  int v254 = v253[15];
  bool v970 = !(v252 == v254);
  struct StateT * v964 = (v970 ? ({
    int v255 = v250->timer;
    int v971 = v255 + 15;
    v250->timer = v971;int * v257 = v250->saved_regs;
    int v258 = v257[11];
    int * v259 = v250->regs;
    v259[11] = v258;
...
struct StateT * v644(struct StateT * v645) {
  int v646 = v645->timer;
  int v649 = v646 + 1;
  v645->timer = v649;return v645;
}

struct StateT * v47(struct StateT * v48) {
  int v49 = v48->timer;
  int v1163 = v49 + 1;
  v48->timer = v1163;int * v51 = v48->regs;
  int v52 = v51[13];
  int * v53 = v48->regs;
  v53[13] = v52;
...
struct StateT * v433(struct StateT * v434) {
  ...
  int v439 = v434->timer;
  int v823 = v439 + 1;
  v434->timer = v823;int * v441 = v434->regs;
  int v442 = v441[12];
  int * v443 = v434->regs;
  int v826 = v442 + 4;
  v443[12] = v826;
...
struct StateT * v225(struct StateT * v226) {
  ...
  int v231 = v226->timer;
  int v1007 = v231 + 1;
  v226->timer = v1007;int * v233 = v226->regs;
  int v234 = v233[12];
  int * v235 = v226->regs;
  int v1010 = v234 + 4;
  v235[12] = v1010;
...
struct StateT * v275(struct StateT * v276) {
  int v277 = v276->timer;
  int v280 = v277 + 1;
  v276->timer = v280;return v276;
}

struct StateT * v483(struct StateT * v484) {
  int v485 = v484->timer;
  int v488 = v485 + 1;
  v484->timer = v488;return v484;
}
...
struct StateT * v213(struct StateT * v214) {
  ...
  int v219 = v214->timer;
  int v1019 = v219 + 1;
  v214->timer = v1019;int * v221 = v214->regs;
  int v222 = v221[11];
  int * v223 = v214->regs;
  int v1022 = v222 + -1;
  v223[11] = v1022;
...
struct StateT * v55(struct StateT * v56) {
  ...
  int v61 = v56->timer;
  int v1116 = v61 + 1;
  v56->timer = v1116;int * v63 = v56->regs;
  int v64 = v63[12];
...
struct StateT * v295(struct StateT * v296) {
  ...
  int v298 = v297[11];
  bool v950 = !(v298 == 0);
  struct StateT * v946 = (v950 ? ({
    int v299 = v296->timer;
    int v951 = v299 + 15;
    v296->timer = v951;struct StateT * v942 = v301(v296);
    v942;
  }) : ({

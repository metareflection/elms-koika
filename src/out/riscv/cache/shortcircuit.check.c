...
struct StateT * v124(struct StateT * v125) {
  int v126 = v125->timer;
  int v256 = v126 + 1;
  v125->timer = v256;int * v128 = v125->regs;
  int v129 = v128[6];
...
struct StateT * v19(struct StateT * v20) {
  int v21 = v20->timer;
  int v391 = v21 + 1;
  v20->timer = v391;int * v23 = v20->regs;
  v23[15] = 16;
...
struct StateT * v46(struct StateT * v47) {
  int v48 = v47->timer;
  int v364 = v48 + 1;
  v47->timer = v364;int * v50 = v47->regs;
  int v51 = v50[12];
  int * v52 = v47->regs;
  int v53 = v52[14];
  int * v54 = v47->regs;
...
struct StateT * v25(struct StateT * v26) {
  int v27 = v26->timer;
  int v378 = v27 + 1;
  v26->timer = v378;int * v29 = v26->regs;
  int v30 = v29[14];
  int * v31 = v26->regs;
  int v32 = v31[15];
  bool v383 = v30 >= v32;
  struct StateT * v376 = (v383 ? ({
...
struct StateT * v182(struct StateT * v183) {
  int v184 = v183->timer;
  int v243 = v184 + 1;
  v183->timer = v243;int * v186 = v183->regs;
  int v187 = v186[10];
  int * v188 = v183->regs;
  int v189 = v188[11];
  bool v248 = !(v187 == v189);
  struct StateT * v241 = (v248 ? ({
...
struct StateT * v114(struct StateT * v115) {
  int v116 = v115->timer;
  int v304 = v116 + 1;
  v115->timer = v304;int * v118 = v115->regs;
  int v119 = v118[13];
  int * v120 = v115->regs;
  int v121 = v120[14];
  int * v122 = v115->regs;
...
struct StateT * v190(struct StateT * v191) {
  int v192 = v191->timer;
  int v204 = v192 + 1;
  v191->timer = v204;int * v194 = v191->regs;
  v194[10] = 0;
...
struct StateT * v220(struct StateT * v221) {
  int v222 = v221->timer;
  int v227 = v222 + 1;
  v221->timer = v227;struct StateT * v225 = v25(v221);
  return v225;
}
...
struct StateT * v212(struct StateT * v213) {
  int v214 = v213->timer;
  int v232 = v214 + 1;
  v213->timer = v232;int * v216 = v213->regs;
  int v217 = v216[14];
  int * v218 = v213->regs;
  int v236 = v217 + 4;
  v218[14] = v236;
...
struct StateT * v56(struct StateT * v57) {
  int v58 = v57->timer;
  int v316 = v58 + 1;
  v57->timer = v316;int * v60 = v57->regs;
  int v61 = v60[5];
...
struct StateT * v13(struct StateT * v14) {
  int v15 = v14->timer;
  int v399 = v15 + 1;
  v14->timer = v399;int * v17 = v14->regs;
  v17[14] = 0;

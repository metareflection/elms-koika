...
struct StateT * v19(struct StateT * v20) {
  int v21 = v20->timer;
  int v280 = v21 + 1;
  v20->timer = v280;int * v23 = v20->regs;
  int v24 = v23[10];
  int * v25 = v20->regs;
  int v26 = v25[15];
  bool v285 = v24 >= v26;
  struct StateT * v278 = (v285 ? v20 : ({
...
struct StateT * v104(struct StateT * v105) {
  int v106 = v105->timer;
  int v163 = v106 + 1;
  v105->timer = v163;int * v108 = v105->regs;
  int v109 = v108[11];
...
struct StateT * v38(struct StateT * v39) {
  int v40 = v39->timer;
  int v218 = v40 + 1;
  v39->timer = v218;int * v42 = v39->regs;
  int v43 = v42[5];
...
struct StateT * v13(struct StateT * v14) {
  int v15 = v14->timer;
  int v291 = v15 + 1;
  v14->timer = v291;int * v17 = v14->regs;
  v17[15] = 80;
...
struct StateT * v28(struct StateT * v29) {
  int v30 = v29->timer;
  int v266 = v30 + 1;
  v29->timer = v266;int * v32 = v29->regs;
  int v33 = v32[13];
  int * v34 = v29->regs;
  int v35 = v34[10];
  int * v36 = v29->regs;
...
struct StateT * v96(struct StateT * v97) {
  int v98 = v97->timer;
  int v209 = v98 + 1;
  v97->timer = v209;int * v100 = v97->regs;
  int v101 = v100[11];
  int * v102 = v97->regs;
  int v213 = v101 << 2;
  v102[11] = v213;

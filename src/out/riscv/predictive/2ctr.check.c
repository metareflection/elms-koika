...
struct StateT * v1(struct StateT * v2) {
  int v3 = v2->timer;
  int v281 = v3 + 1;
  v2->timer = v281;struct StateT * v279 = v5(v2);
  return v279;
}
...
struct StateT * v137(struct StateT * v138) {
  ...
  int v140 = v139[10];
  bool v157 = v140 == 0;
  struct StateT * v153 = (v157 ? ({
    int v141 = v138->timer;
    int v158 = v141 + 15;
    v138->timer = v158;int * v143 = v138->saved_regs;
    int v144 = v143[11];
    int * v145 = v138->regs;
    v145[11] = v144;
...
struct StateT * v75(struct StateT * v76) {
  ...
  int v81 = v76->timer;
  int v174 = v81 + 1;
  v76->timer = v174;int * v83 = v76->regs;
  int v84 = v83[11];
...
struct StateT * v67(struct StateT * v68) {
  int v69 = v68->timer;
  int v221 = v69 + 1;
  v68->timer = v221;int * v71 = v68->regs;
  int v72 = v71[11];
  int * v73 = v68->regs;
  int v225 = v72 << 2;
  v73[11] = v225;

...
struct StateT * v19(struct StateT * v20) {
  int v21 = v20->timer;
  int v340 = v21 + 1;
  v20->timer = v340;struct StateT * v338 = v23(v20);
  return v338;
}
...
struct StateT * v107(struct StateT * v108) {
  ...
  int v113 = v108->timer;
  int v218 = v113 + 1;
  v108->timer = v218;int * v115 = v108->regs;
  int v116 = v115[11];
...
struct StateT * v23(struct StateT * v24) {
  ...
  int v29 = v24->timer;
  int v329 = v29 + 1;
  v24->timer = v329;int * v31 = v24->regs;
  int v32 = v31[13];
  int * v33 = v24->regs;
  int v34 = v33[10];
  int * v35 = v24->regs;
...
struct StateT * v169(struct StateT * v170) {
  ...
  int v174 = v173[15];
  bool v197 = v172 >= v174;
  struct StateT * v191 = (v197 ? ({
    int v175 = v170->timer;
    int v198 = v175 + 15;
    v170->timer = v198;int * v177 = v170->saved_regs;
    int v178 = v177[5];
    int * v179 = v170->regs;
    v179[5] = v178;
...
struct StateT * v37(struct StateT * v38) {
  ...
  int v43 = v38->timer;
  int v278 = v43 + 1;
  v38->timer = v278;int * v45 = v38->regs;
  int v46 = v45[5];
...
struct StateT * v13(struct StateT * v14) {
  int v15 = v14->timer;
  int v345 = v15 + 1;
  v14->timer = v345;int * v17 = v14->regs;
  v17[15] = 80;
...
struct StateT * v99(struct StateT * v100) {
  int v101 = v100->timer;
  int v265 = v101 + 1;
  v100->timer = v265;int * v103 = v100->regs;
  int v104 = v103[11];
  int * v105 = v100->regs;
  int v269 = v104 << 2;
  v105[11] = v269;

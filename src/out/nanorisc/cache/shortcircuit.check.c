...
struct StateT * x19(struct StateT * x20) {
  int x21 = x20->timer;
  int x332 = x21 + 1;
  x20->timer = x332;int * x23 = x20->regs;
  int x24 = x23[4];
  bool x335 = x24 >= 4;
  struct StateT * x330 = (x335 ? ({
...
struct StateT * x158(struct StateT * x159) {
  int x160 = x159->timer;
  int x218 = x160 + 1;
  x159->timer = x218;int * x162 = x159->regs;
  int x163 = x162[0];
  int * x164 = x159->regs;
  int x165 = x164[1];
  bool x223 = !(x163 == x165);
  struct StateT * x216 = (x223 ? ({
...
struct StateT * x38(struct StateT * x39) {
  int x40 = x39->timer;
  int x281 = x40 + 1;
  x39->timer = x281;int * x42 = x39->regs;
  int x43 = x42[2];
  int * x44 = x39->regs;
  int x45 = x44[4];
...
struct StateT * x195(struct StateT * x196) {
  int x197 = x196->timer;
  int x202 = x197 + 1;
  x196->timer = x202;struct StateT * x200 = x19(x196);
  return x200;
}
...
struct StateT * x187(struct StateT * x188) {
  int x189 = x188->timer;
  int x207 = x189 + 1;
  x188->timer = x207;int * x191 = x188->regs;
  int x192 = x191[4];
  int * x193 = x188->regs;
  int x211 = x192 + 1;
  x193[4] = x211;
...
struct StateT * x13(struct StateT * x14) {
  int x15 = x14->timer;
  int x343 = x15 + 1;
  x14->timer = x343;int * x17 = x14->regs;
  x17[4] = 0;
...
struct StateT * x98(struct StateT * x99) {
  int x100 = x99->timer;
  int x231 = x100 + 1;
  x99->timer = x231;int * x102 = x99->regs;
  int x103 = x102[3];
  int * x104 = x99->regs;
  int x105 = x104[4];
...
struct StateT * x166(struct StateT * x167) {
  int x168 = x167->timer;
  int x180 = x168 + 1;
  x167->timer = x180;int * x170 = x167->regs;
  x170[0] = 0;
